...
public interface IDevice {
	...
	public static final int ERROR_NOREPLY = -8; // Нет ответа устройства
	public static final int ERROR_INVPARAM = -9; // Неверное значение параметра
	...
	public static final String TEXT_ERROR_PASSWORD = "Параметр-пароль не установлен";
        public static final String TEXT_ERROR_NOREPLY = "Нет ответа от устройства";
	public static final String TEXT_ERROR_INVPARAM = "Неверное значение параметра";
