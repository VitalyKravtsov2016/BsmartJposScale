...
public class MainDialog extends JDialog {
    ...
    public MainDialog() {
        ...
        setTitle("BSMART: Программа градуировки весовой ячейки ВМ-100");
        ...
        contentPanel.setLayout(null);
        {
            ...
            buttonPane.setBounds(0, 347, 501, 60);
            ...
            buttonPane.setLayout(null);
            {
                ...
                btnPrev.setBounds(180, 8, 100, 30);
            ...
            }
            {
                ...
                btnNext.setBounds(288, 8, 100, 30);
            ...
            }
            {
                ...
                btnCancel.setBounds(395, 8, 100, 30);
                btnCancel.setActionCommand("Cancel");
                buttonPane.add(btnCancel);
            }

            JSeparator separator = new JSeparator();
            separator.setBounds(10, 0, 485, 30);
    ...
    public void showPage(int index) {
        ...
        if (index != pageIndex) {
            ...
            if (validPage(index)) {
                PropertyPage page = pages.get(index);
                page.updatePage();
    ...
    public void updatePage() {
        if (validPage(pageIndex)) {
            PropertyPage page = pages.get(pageIndex);
            page.updatePage();
        }
        if (isCalibrationStarted()) {
